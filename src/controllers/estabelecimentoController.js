...
import { formatProdutoList, hasProduto, serializeProdutos } from '../utilities/produtoUtils.js';
...
class EstabelecimentoController {
    index = async (req, res) => {
        ...
        try {
            ...
            estabelecimentos = estabelecimentos.map((estabelecimento) => {
                ...
                estabelecimento.produtoFormatado = formatProdutoList(estabelecimento.produto);
    ...
    addEstabelecimento = async (req, res) => {
        ...
        try {
            ...
            if (!produtos) {
                throw new Error('Selecione pelo menos um produto para o estabelecimento.');
            }
            ...
            return res.status(201).render('pages/estabelecimentos/cadastrarEstabelecimento', {
                title: 'Cadastrar Estabelecimento',
                estabelecimento,
            ...
            return res.status(500).render('pages/estabelecimentos/cadastrarEstabelecimento', {
                title: 'Cadastrar Estabelecimento',
                success: null,
                usuario,
    ...
    editEstabelecimento = async (req, res) => {
        ...
        try {
            ...
            return res.status(200).render('pages/estabelecimentos/editarEstabelecimento', {
            ...
            return res.status(500).render('pages/estabelecimentos/editarEstabelecimento', {
                title: 'Editar Estabelecimento',
    ...
    editEstabelecimentoForm = async (req, res) => {
        ...
        try {
            ...
            return res.status(500).json({ message: 'Erro ao buscar dados do estabelecimento.' });
        }
    };
    ...
    viewEstabelecimento = async (req, res) => {
        ...
        try {
            ...
            return res.status(200).render('pages/estabelecimentos/visualizarEstabelecimento', {
